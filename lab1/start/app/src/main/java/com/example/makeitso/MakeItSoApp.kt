...
import com.example.makeitso.screens.profile.UserProfileScreen
import com.example.makeitso.screens.protectedZone.ProtectedScreen
...
fun NavGraphBuilder.makeItSoGraph(appState: MakeItSoAppState) {
  ...
  composable(PROFILE_SCREEN) {
    UserProfileScreen(openAndPopUp = { route, popUp -> appState.navigateAndPopUp(route, popUp) })
  }

  composable(PROTECTED_SCREEN) {
    ProtectedScreen(openAndPopUp = { route, popUp -> appState.navigateAndPopUp(route, popUp) })
  }
